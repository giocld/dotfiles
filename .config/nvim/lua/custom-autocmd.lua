...
api.nvim_create_autocmd("ColorScheme", {
  ...
  callback = function()
    -- For yank highlight
    vim.api.nvim_set_hl(0, "YankColor", { fg = "#34495E", bg = "#D8933E", ctermfg = 59, ctermbg = 41 })

    -- For cursor colors
    vim.api.nvim_set_hl(0, "Cursor", { fg = "black", bg = "#D8933E", bold = true })
    vim.api.nvim_set_hl(0, "Cursor2", { fg = "red", bg = "#D8933E" })

    -- For floating windows border highlight (nord palette)
    vim.api.nvim_set_hl(0, "FloatBorder", { fg = "#4C566A", bg = "None", bold = true })

    -- Nord-flavored diagnostic highlights for floating windows
    vim.api.nvim_set_hl(0, "DiagnosticFloatingError", { fg = "#BF616A", bg = "None" })
    vim.api.nvim_set_hl(0, "DiagnosticFloatingWarn", { fg = "#EBCB8B", bg = "None" })
    vim.api.nvim_set_hl(0, "DiagnosticFloatingInfo", { fg = "#81A1C1", bg = "None" })
    vim.api.nvim_set_hl(0, "DiagnosticFloatingHint", { fg = "#A3BE8C", bg = "None" })
    vim.api.nvim_set_hl(0, "DiagnosticFloatingOk", { fg = "#88C0D0", bg = "None" })
