...
require("lualine").setup {
  options = {
    ...
    theme = {
      normal = {
        a = { fg = "#ECEFF4", bg = "#4C566A", gui = "bold" },
        b = { fg = "#D8DEE9", bg = "#3B4252" },
        c = { fg = "#D8DEE9", bg = "#2E3440" },
      },
      insert = {
        a = { fg = "#ECEFF4", bg = "#81A1C1", gui = "bold" },
        b = { fg = "#D8DEE9", bg = "#3B4252" },
        c = { fg = "#D8DEE9", bg = "#2E3440" },
      },
      visual = {
      ...
      replace = {
        a = { fg = "#ECEFF4", bg = "#BF616A", gui = "bold" },
        b = { fg = "#D8DEE9", bg = "#3B4252" },
        c = { fg = "#D8DEE9", bg = "#2E3440" },
      },
      command = {
      ...
      terminal = {
        a = { fg = "#ECEFF4", bg = "#8FBCBB", gui = "bold" },
        b = { fg = "#D8DEE9", bg = "#3B4252" },
        c = { fg = "#D8DEE9", bg = "#2E3440" },
      },
      inactive = {
        a = { fg = "#D8DEE9", bg = "#4C566A" },
        b = { fg = "#D8DEE9", bg = "#3B4252" },
        c = { fg = "#D8DEE9", bg = "#2E3440" },
      },
      diagnostics = {
        error = { fg = "#BF616A", gui = "bold" },
        warn = { fg = "#EBCB8B", gui = "bold" },
        info = { fg = "#81A1C1" },
        hint = { fg = "#A3BE8C" },
      },
    },
