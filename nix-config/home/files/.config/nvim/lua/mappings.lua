...
keymap.set("n", "<leader>bc", "<cmd>bdelete<cr>", { silent = true, desc = "close current buffer" })
...
keymap.set("n", "<leader>H", "<cmd>Alpha<cr>", { desc = "open home screen" })
...
-- Toggle Supermaven
keymap.set("n", "<leader>a", "<cmd>SupermavenToggle<cr>", { silent = true, desc = "toggle Supermaven" })
